...
std::vector<uint64_t> neighbours(dd4hep::DDSegmentation::BitFieldCoder& aDecoder,
...
std::vector<std::pair<int, int>> bitfieldExtremes(dd4hep::DDSegmentation::BitFieldCoder& aDecoder,
                                                  const std::vector<std::string>& aFieldNames) {
