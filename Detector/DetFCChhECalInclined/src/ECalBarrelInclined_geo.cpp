...
static DD4hep::Geometry::Ref_t createECalBarrelInclined(DD4hep::Geometry::LCDD& aLcdd,
  ...
  DD4hep::Geometry::Tube bathOuterShape(bathRmin, bathRmax, caloDim.dz()); // make it 4 volumes + 5th for detector envelope
  if (cryoThicknessFront > 0) {
    // 1. Create cryostat
    DD4hep::Geometry::Tube cryoFrontShape(cryoDim.rmin1(), cryoDim.rmin2(), cryoDim.dz());
    DD4hep::Geometry::Tube cryoBackShape(cryoDim.rmax1(), cryoDim.rmax2(), cryoDim.dz());
    DD4hep::Geometry::Tube cryoSideOuterShape(cryoDim.rmin2(), cryoDim.rmax1(), cryoDim.dz());
    DD4hep::Geometry::SubtractionSolid cryoSideShape(cryoSideOuterShape, bathOuterShape);
    ...
    DD4hep::Geometry::Volume cryoFrontVol(cryostat.nameStr()+"_front", cryoFrontShape, aLcdd.material(cryostat.materialStr()));
    DD4hep::Geometry::Volume cryoBackVol(cryostat.nameStr()+"_back", cryoBackShape, aLcdd.material(cryostat.materialStr()));
    DD4hep::Geometry::Volume cryoSideVol(cryostat.nameStr()+"_side", cryoSideShape, aLcdd.material(cryostat.materialStr()));
    DD4hep::Geometry::PlacedVolume cryoFrontPhysVol = envelopeVol.placeVolume(cryoFrontVol);
    DD4hep::Geometry::PlacedVolume cryoBackPhysVol = envelopeVol.placeVolume(cryoBackVol);
    DD4hep::Geometry::PlacedVolume cryoSidePhysVol = envelopeVol.placeVolume(cryoSideVol);
    ...
    DD4hep::Geometry::DetElement cryoFrontDetElem(caloDetElem, "cryo_front", 0);
    cryoFrontDetElem.setPlacement(cryoFrontPhysVol);
    DD4hep::Geometry::DetElement cryoBackDetElem(caloDetElem, "cryo_back", 0);
    cryoBackDetElem.setPlacement(cryoBackPhysVol);
    DD4hep::Geometry::DetElement cryoSideDetElem(caloDetElem, "cryo_side", 0);
    cryoSideDetElem.setPlacement(cryoSidePhysVol);
    // 1.2. Create place-holder for services
    DD4hep::Geometry::Tube servicesFrontShape(cryoDim.rmin2(), bathRmin, caloDim.dz());
    DD4hep::Geometry::Tube servicesBackShape(bathRmax, cryoDim.rmax1(), caloDim.dz());
    ...
    DD4hep::Geometry::Volume servicesFrontVol("services_front", servicesFrontShape, aLcdd.material(activeMaterial));
    DD4hep::Geometry::Volume servicesBackVol("services_back", servicesBackShape, aLcdd.material(activeMaterial));
    DD4hep::Geometry::PlacedVolume servicesFrontPhysVol = envelopeVol.placeVolume(servicesFrontVol);
    DD4hep::Geometry::PlacedVolume servicesBackPhysVol = envelopeVol.placeVolume(servicesBackVol);
    if (cryoFrontSensitive) {
    ...
    DD4hep::Geometry::DetElement servicesFrontDetElem(caloDetElem, "services_front", 0);
    servicesFrontDetElem.setPlacement(servicesFrontPhysVol);
    DD4hep::Geometry::DetElement servicesBackDetElem(caloDetElem, "services_back", 0);
