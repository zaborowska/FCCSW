...
// Read Handler
//------------------------------------------------------------------------------
void PropertyAlgTool::readHandler(Property& p)
{
...
// Update Handler
//------------------------------------------------------------------------------
void PropertyAlgTool::updateHandler(Property& p)
{
  MsgStream log(msgSvc(),name());
...
// Constructor
//------------------------------------------------------------------------------
PropertyAlgTool::PropertyAlgTool (const std::string& aType , const std::string& aName,
...
//------------------------------------------------------------------------------
  ...
  p_double.declareUpdateHandler( &PropertyAlgTool::updateHandler, this );
  p_double.declareReadHandler( &PropertyAlgTool::readHandler, this );

  MsgStream log(msgSvc(),"PropertyAlgTool");
...
//------------------------------------------------------------------------------
StatusCode PropertyAlgTool::initialize() {
//------------------------------------------------------------------------------
  MsgStream log(msgSvc(), name());
...
//------------------------------------------------------------------------------
StatusCode PropertyAlgTool::finalize() {
//------------------------------------------------------------------------------
  MsgStream log(msgSvc(), name());
...
DECLARE_TOOL_FACTORY(PropertyAlgTool)
