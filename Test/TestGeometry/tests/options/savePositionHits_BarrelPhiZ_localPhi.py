...
reader = HepMCReader("Reader", Filename="testHepMCrandom_ECal.dat")
...
geoservice = GeoSvc("GeoSvc", detectors=['file:Test/TestGeometry/data/BarrelPhiZ_volumes_localPhi.xml'])
readout = "ECalHits"
