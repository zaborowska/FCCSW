...
geoservice = GeoSvc("GeoSvc", detectors=['file:Test/TestGeometry/data/TestBoxCaloSD_volumes_localPhi.xml'])
readout = "ECalHits"
...
geantsim = SimG4Alg("SimG4Alg", outputs= ["SimG4SaveCalHits/saveCalHits"])
...
out = PodioOutput("out", filename="test_position_hits_volumes_localPhi.root")
