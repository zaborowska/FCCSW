...
from Configurables import G4SimSvc, G4FtfpBert
physlist = G4FtfpBert("G4FtfpBert", useCoupledTransportation="true")
geantservice = G4SimSvc("G4SimSvc", detector='G4DD4hepDetector', physicslist=physlist, actions="G4FullSimActions", )
